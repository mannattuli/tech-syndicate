...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference("Homework.count") do
      post homeworks_url, params: { homework: { desc: @homework.desc, end: @homework.end, subject: @homework.subject } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { desc: @homework.desc, end: @homework.end, subject: @homework.subject } }
